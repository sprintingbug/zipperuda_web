...
<body>
    ...
    <?php include 'inc/nav.php'; ?>
        ...
        <?php include 'inc/info-col.php'; ?>
                <h2 class="white-text">Homepage</h1>
                
                <div class="gallery">
                    <div class="main-image-container">
                        <img src="sl3.jpg" class="main-image" alt="Main Cat Image" id="main-image">
                    </div>
                    <div class="thumbnails">
                        <img src="sl3.jpg" alt="Thumbnail 1" class="thumbnail" data-src="sl3.jpg">
